...
We call this task \textbf{relative debugging}, following the compare-against-reference paradigm of Abramson et al.~\cite{abramson1996relative,abramson1995sc,sosic1997guard}: given a passing trace~$P$ and a failing trace~$F$ for the same test case, rank execution steps by how likely each is the \emph{earliest root cause} of the regression.
